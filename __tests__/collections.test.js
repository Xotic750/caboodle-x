...
describe('Collections', () => {
  ...
  describe('Map', () => {
    ...
    it('constructor behavior', () => {
      ...
      if (proto in {}) {
        ...
        expect(new MapObject()[proto].isPrototypeOf(new MapObject())).toBe(
          true,
        );
  ...
  describe('Set', () => {
    ...
    it('constructor behavior', () => {
      ...
      if (proto in {}) {
        // eslint-disable-next-line no-prototype-builtins
        expect(new SetObject()[proto].isPrototypeOf(new SetObject())).toBe(
          true,
        );
